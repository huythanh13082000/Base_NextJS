...
export const metadata: Metadata = {
  ...
  description:
    "GM4 기술 솔루션즈는 투명하고 합리적인 가격 산정으로 고객들의 프로젝트를 지원합니다. 우리의 비용 산정은 프로젝트의 규모, 요구 사항, 그리고 고객의 목표를 고려하여 맞춤형으로 제공됩니다." +
    "서비스 및 솔루션 비용:\n" +
    ...
    "GM4 기술 솔루션즈는 고객의 예산과 목표를 고려하여 최상의 가치를 제공하기 위해 노력하고 있습니다. 저희와 함께하면 효율적이고 투명한 비용 산정을 통해 프로젝트를 안정적으로 진행할 수 있습니다.",
  alternates: {
