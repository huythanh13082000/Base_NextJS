...
export default function Home() {
  return (
    <main className='min-h-screen'>
      <div className="bg-[url('/images/background.svg')] w-full h-[954px] flex items-center justify-center">
        <div className='flex items-center'>
          <div className='text-white'>
            <Image src={'/images/logo.png'} alt='' width={123} height={72} />

            <p className='xl:text-6xl xl:mt-8 font-bold'>웨딩토크</p>
            <p className='font-bold text-[40px] xl:mt-7 leading-[60px] opacity-65'>
              결혼하고 싶은 그 사람 <br />
              바로 여기 있어요
            </p>
            <div>
              <p className='mt-[60px] mb-[23px] text-[13px] font-bold uppercase'>
                Download our app
              </p>
      ...
      <div className='xl:py-[100px] flex gap-[73px] justify-center items-center'>
        <Image src={'/images/image1.svg'} alt='' width={582} height={548} />
        <div className='flex flex-col gap-6 text-[19px] opacity-70 leading-[30px] text-[#161C2D]'>
          <p className='text-5xl font-bold leading-[60px] text-black'>
            결혼할 상대를 찾고 <br />
            있나요?
          </p>
          <p>
      ...
      <div className='xl:py-[100px] flex gap-[32px] justify-center items-center'>
        <div className='flex flex-col gap-6 leading-[30px] text-[#161C2D]'>
          <p className='text-5xl font-bold leading-[60px] text-black'>
            웨딩토크에서 가능해요
          </p>
          ...
          <div>
            <p className='font-bold text-xl'>약속해요</p>
            <p className='opacity-70 text-[17px]'>
              웨딩토크에서는 사진도 용이 불가능하도록 제출 <br />한 사진과 현재
              카메라에 비친 내 모습의 AI 판독!
            </p>
          </div>
          <div>
            <p className='font-bold text-xl'>인증해요</p>
            <p className='opacity-70 text-[17px]'>
      ...
      <div className='pt-[66px] flex flex-col justify-center items-center'>
        <p className='font-bold text-5xl mb-6'>어떻게 가입하나요?</p>
        <p className='text-[19px] opacity-70'>
          간편한 전화번호 인증으로 가입해 보세요
        </p>

        <div className='mt-[100px] flex gap-[100px] relative mb-[300px]'>
        ...
        <div className="bg-[url('/images/background-black.svg')] pt-[300px] py-[100px] w-full text-white flex flex-col justify-center items-center">
          <div>
            <p className='font-bold text-5xl text-center mt-[100px] leading-[60px]'>
              웨딩토크에서는 어떤 기능이 <br />
              있는지 알고 싶으신가요?
            </p>
          </div>

          <div className='flex gap-11 mt-[88px] flex-wrap max-w-[1097px] justify-center'>
            <div className='flex gap-6 items-start'>
              ...
              <div className='flex flex-col gap-4'>
                <p className='font-bold text-[21px]'>채팅 기능</p>
            ...
            <div className='flex gap-6 items-start'>
              ...
              />
              <div className='flex flex-col gap-4'>
                <p className='font-bold text-[21px]'>소개 카드</p>
                <p className='opacity-65'>
          ...
          <div className='w-[161px] h-[1px] bg-[#D8D8D8] mt-11 mb-[100px] opacity-10'></div>

          <div>
            <p className='text-[32px] font-bold leading-10 mb-[32px] text-center'>
              웨딩토크에서 결혼상대를 만나보세요
            ...
            <div className='flex justify-center mt-11'>
              <button className='text-[#68D585] flex gap-2 items-center font-bold'>
                Read more reviews{' '}
                <Image
        ...
        <div className='pt-[60px] bg-[#F4F7FA]'>
          <p className='text-5xl font-bold text-center'>비용이 걱정되시나요?</p>
          <br />
          <p className='text-[19px] opacity-70 text-[#161C2D] text-center'>
            결혼 중계와 비교도 안되는 비용으로 이용 가능해요
          </p>

          <div className='flex gap-[30px] mt-11 justify-center mb-36'>
            <CardPrice />
            <CardPrice />
          </div>
