...
const AboutCategoryLayout = ({ title, listItem }: AboutCategoryProps) => {
  return (
    <div className="flex max-md:flex-col lg:gap-0 md:gap-6 gap-5 max-md:items-start">
      <p className="bg-title lg:w-[175px] text-transparent bg-clip-text">
        {title}
      </p>
      <div className="flex flex-wrap gap-[58px] max-lg:gap-12 max-md:gap-8 items-center">
