    ...
    <section className={className}>
      <div className="relative w-full text-center h-[390px]">
        ...
        <div className="relative flex flex-col items-center">
          ...
          <Button className="translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:600ms] hover:shadow-secondary transition-[shadow,text-shadow] [&_.highlight]:ml-2">
            Start building
          </Button>
        </div>
      </div>

      <div className="relative w-full h-[675px] flex items-center justify-center animate-image-rotate before:animate-image-glow before:absolute before:top-0 before:left-0 before:h-full before:w-full before:bg-blue-800 before:opacity-0 before:[filter:blur(120px)]">
